# Wallet Helper Node: 101.47.179.91

Role: wallet helper.

Node ID: `wallet-helper-1`.
...
sudo bash scripts/configure_wallet_helper.sh wallet-helper-1 101.47.178.69 6
```
